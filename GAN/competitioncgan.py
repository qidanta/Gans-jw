...
from util.train_util import find_best_netG, find_best_netG_v1dot2
from util.vision_util import create_sigle_experiment
import random


class _competitionCGan(_baseModel):
    ...
    def load_networkG(self, g_network_path):
        ...
        '''
        self.netGs[0].load_state_dict(torch.load(g_network_path))
