...
from util.train_util import (find_best_netG,
                             find_best_netG_v1dot1, find_best_netG_v1dot2, find_best_netG_v1dot3, 
                             link2condition_data)
...
class _competitionGan(_baseModel):
    ...
    def __str__(self):
        ...
        netC = self.netC.__str__()
        return 'Gan:\n' + '{}_{}{}{}'.format('v1.4.4', netG, netD, netC)
