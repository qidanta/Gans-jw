...
from GAN.competition_gan import _competitionGan
...
parser.add_argument('--savepath', default='testout/', help='the folder saved .pth and img results')
...
parser.add_argument('--niter', default=2, help='iter how many times')
...
parser.add_argument('--g_network_path', default='/home/eric/Desktop/Project-PY/pro-py27/01GANs/02competitiongan/out/epoch_2000_netG2.pth')
parser.add_argument('--d_network_path', default='/home/eric/Desktop/Project-PY/pro-py27/01GANs/02competitiongan/out/netD_epoch_2000.pth')
